                ...
                <div class="card-header search-card">
                    <div class="d-flex justify-content-between">
                        ...
                        @can('revenueCategory_create')
                            <a href="{{ route('admin.generalSetting.revenue-category.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-1">
                                            @can('revenueCategory_edit')
                                                <a data-bs-type="edit"
                                                    href="{{ route('admin.generalSetting.revenue-category.edit', [$revenueCategory]) }}"
                                            ...
                                            @can('revenueCategory_delete')
                                                <form
                                                    action="{{ route('admin.generalSetting.revenue-category.destroy', [$revenueCategory]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
