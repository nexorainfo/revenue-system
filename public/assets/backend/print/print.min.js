!function (e, t) {
    ...
    return function (e) {
        ...
        var y = function (e, t) {
            ...
            n ? (e.printableElement = function r(e, t) {
                for (var n = e.cloneNode(), o = Array.prototype.slice.call(e.childNodes), i = 0; i < o.length; i++) if (-1 === t.ignoreElements.indexOf(o[i].id)) {
                    var a = r(o[i], t);
                    n.appendChild(a)
                }
                ...
                return n
            }(n, e), e.header && s(e.printableElement, e), f.send(e, t)) : window.console.error("Invalid HTML element id: " + e.printable)
        };
        var h = function (e, t) {
        ...
        var v = function (e, t) {
            ...
            e.properties = e.properties.map((function (t) {
                return {
                    field: "object" === w(t) ? t.field : t,
                    displayName: "object" === w(t) ? t.displayName : t,
                    columnSize: "object" === w(t) && t.columnSize ? t.columnSize + ";" : 100 / e.properties.length + "%;"
                }
        ...
        var S = ["pdf", "html", "image", "json", "raw-html"], x = function () {
            var e = {
                printable: null,
